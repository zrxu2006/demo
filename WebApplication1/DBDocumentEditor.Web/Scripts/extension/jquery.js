        ...
        id: null, title: null, iconCls: null, width: "auto", height: "auto", left: null, top: null, cls: null, headerCls: null, bodyCls: null, style: {}, href: null, cache: true, fit: false, border: true, doSize: true, noheader: false, content: null, collapsible: false, minimizable: false, maximizable: false, closable: false, collapsed: false, minimized: false, maximized: false, closed: false, openAnimation: false, openDuration: 400, closeAnimation: false, closeDuration: 400, tools: null, footer: null, header: null, queryParams: {}, method: "get", href: null, loadingMessage: "Loading...", loader: function (_267, _268, _269) {
            ...
            $.ajax({
                type: opts.method, url: opts.href, cache: false, data: _267, dataType: "html", success: function (data) {
                    var curData = data.Data == undefined ? data : data.Data;
                    _268(curData);
                }, error: function () {
...
//------------gridbox tools------------
//------------gridbox tools------------
$.fn.searchBox = function (surl, tconfig) {
    tconfig = tconfig == undefined ? {} : tconfig;
    $(this).combobox({
        url: surl,
        width: tconfig.width,
        valueField: 'id',
        ...
        delay: 100,
        hasDownArrow: false,
        multiple: tconfig.multiple == undefined ? null : tconfig.multiple,
        data: tconfig.data == undefined ? null : tconfig.data,
        prompt: tconfig.prompt == undefined ? null : tconfig.prompt,
        icons: tconfig.hasicon == undefined ? null : tconfig.hasicon == false ? null : [{ iconCls: 'icon-search' }],
        filter: function (q, row) {
            var tval = $(this).combobox("getText");
            if ($.trim(tval) == "")
                return false;
            else
                return row.searchtext.indexOf(tval) != -1;
        }
    });
}

$.fn.searchCombobox = function (surl, cdata, pHeight) {
    $(this).combobox({
        url: surl,
        valueField: 'id',
        textField: 'text',
...
$.fn.mulCombobox = function (surl, cdata) {
    $(this).combobox({
        url: surl,
        valueField: 'id',
        textField: 'text',
...
$.fn.gridBox = function (config) {
    ...
    var tempConfig = {
        ...
        url: config.url,
        nowrap: false,
        striped: config.striped ? config.striped : striped,
        title: config.title ? config.title : title,
        fitColumns: config.fitColumns != undefined ? config.fitColumns : fitColumns,
        singleSelect: config.singleSelect != undefined ? config.singleSelect : singleSelect,
        rownumbers: config.rownumbers != undefined ? config.rownumbers : rownumbers,
        toolbar: config.toolbar != undefined ? config.toolbar : toolbar,
        pagination: config.pagination != undefined ? config.pagination : pagination,
        sortName: config.sortName ? config.sortName : sortName,
        sortOrder: config.sortOrder ? config.sortOrder : sortOrder,
        pageSize: config.pageSize ? config.pageSize : pageSize,
        pageList: pageList,
        queryParams: config.queryParams ? config.queryParams : queryParams,
        ...
        onClickCell: config.onClickCell
    };
    if (config.view != undefined) {
        tempConfig.view = config.view;
    }
    if (config.detailFormatter != undefined) {
        tempConfig.detailFormatter = config.detailFormatter;
    }
    $(this).datagrid(tempConfig)
}